  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <div className="flex items-center gap-4 mb-12">
        ...
        <h1 className="text-xl">→ Generate Image</h1>
      </div>
        ...
        <div className="space-y-8 border-r border-white/10 pr-8">
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                <p>First, we'll set up our image generation parameters.</p>
                <p className="text-white/60">Define the prompt and image specifications.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                <p>Then we'll implement the generation process.</p>
                <p className="text-white/60">Connect to an image generation API and handle the response.</p>
              </div>
            </div>
          </div>
        </div>
